...
\- `instancia\_ec2\_criada.png` - Screenshot da instância criada

\- `system\_log\_ec2\_instance.png` - System log mostrando boot e instalação
...
\- \[CloudWatch Metrics](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/viewing\_metrics\_with\_cloudwatch.html)
